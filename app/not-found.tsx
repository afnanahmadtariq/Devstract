...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center lg:justify-start bg-white text-center px-4">
      <img src="/media/404.png" alt="404 Not Found" className="w-full md:w-3/5 h-auto" />
