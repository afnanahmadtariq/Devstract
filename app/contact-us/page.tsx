              ...
              <form ref={formRef} onSubmit={handleSubmit} onFocus={handleEmailFocus} className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-0 justify-center items-center w-full">
                  <button 
                    ...
                    className="group flex items-center justify-between p-1 border border-indigo-600 rounded-full text-sm sm:text-base font-medium bg-transparent hover:bg-indigo-50 dark:hover:bg-indigo-900 w-auto min-w-[215px] mx-auto transition-colors"
                  >
                    <span
                    ...
                    {buttonState === 'sending' && (
                      <span className="text-2xl relative -left-6 -top-1" >📨</span>
                    )}
                    <span
