    ...
    <>
      ...
      <main className="flex flex-col min-h-[70vh] bg-white dark:bg-gray-900">
        <section className="flex flex-col items-center justify-center py-16 px-4">
          ...
          <div className="w-full bg-[#F7F7F7] flex flex-col md:flex-row justify-center items-stretch p-3 gap-3 max-w-7xl border-2 border-[#EBEBEB] rounded-2xl">
            {/* Left Side (info and image) */}
            <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow p-8 hidden md:flex flex-col items-center justify-center border-2 border-[#EBEBEB]">
              <img src="/media/baloons.svg" alt="Balloons" className="w-32 h-32 mb-6" />
