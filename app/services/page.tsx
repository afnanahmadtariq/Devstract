        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Web Development</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Mobile App Development</h2>
              <p className="text-gray-600 mb-6">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold mb-4 text-gray-800">UX/UI Design</h2>
              <p className="text-gray-600 mb-6">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Cloud & DevOps</h2>
              <p className="text-gray-600 mb-6">
...
function AdditionalServiceCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
